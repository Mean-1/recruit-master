...
<!--              <span class="company-name">{{ recruiterForm.company_name }}</span>-->
              <el-select v-model="recruiterForm.company_name" placeholder="请选择行业类型" class="company-name">
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            return {
              companyList: ['美团', 'microsoft', 'amazon', 'facebook'],
              menuList: [
                ...
                // recruiterForm: {},
                recruiterForm: {
                    recruiter_id: JSON.parse(window.sessionStorage.getItem('user')).id,
        ...
        methods: {
            ...
            async getRecruiter() {
                ...
                if (res.message == "success") {
                    ...
                    res.obj.recruiter_sex=res.obj.users.gender;
                    res.obj.recruiter_duty=res.obj.duty;
                    res.obj.company_name=res.obj.company.name;
                    this.recruiterForm = Object.assign({},{},res.obj);
                }
            },
                    ...
                    case "recruiterForm":
                      res = await this.$axios.request({
                            ...
                            data: {
                              ...
                              username: this.recruiterForm.recruiter_name,
                              gender:this.recruiterForm.recruiter_sex,
                              duty: this.recruiterForm.recruiter_duty,
                              name: this.recruiterForm.company_name
                            }
                        });
                        console.log(res);
